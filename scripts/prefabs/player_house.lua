...
local function StartTravelSound(inst, doer)
    doer.SoundEmitter:PlaySound("Hamlet/common/objects/store/door_open")
...
return makehouse("playerhouse_city",     "pig_house_sale",       nil,    {indestructable=true} ),	 	   
       --MakePlacer("common/playerhouse_city_placer", "pig_house_sale", "pig_house_sale", "idle")
              MakePlacer("common/playerhouse_city_placer", "pig_house_sale", "pig_house_sale", "idle",nil,nil,nil,0.75,nil,nil,nil,nil,nil, placetestfn)
                    --MakePlacer("common/playerhouse_city_placer", "pig_house_sale", "pig_house_sale", "idle",nil,nil,nil,0.75,nil,nil,nil,nil,nil)