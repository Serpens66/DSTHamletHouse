...
Prefab("deco_antiquities_cornerbeam",         decofn("interior_wall_decals_antiquities", "wall_decals_antiquities", "pillar_corner",     {decal=true, background=3, tags={"NOBLOCK","cornerpost"}}), assets, prefabs),
Prefab("deco_antiquities_cornerbeam2",        decofn("interior_wall_decals_antiquities", "wall_decals_antiquities", "pillar_sidewall",   {decal=true, tags={"NOBLOCK","cornerpost"}}), assets, prefabs),
